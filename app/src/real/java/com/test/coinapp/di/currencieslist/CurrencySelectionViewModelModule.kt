...
import com.test.coinapp.ui.currencyselection.CurrenciesListViewModel
...
@Module
class CurrencySelectionViewModelModule {
    @Provides
    fun provideViewModel(
        ...
        return fragment.getViewModel creator@{
            return@creator CurrenciesListViewModel(application, interactor)
        }
    }
}